		...
		<div class="colorlib-product">
			<div class="container">
				...
				<c:if test="${cartList != null && cartList.size()>0}">	
								...
								<c:forEach var="cart" items="${cartList}" varStatus="status">
									<div class="product-cart d-flex">
										...
										<div class="one-eight text-center">
											<div class="display-tc">
												<span class="price">
											<fmt:formatNumber pattern="###,###,###원" value="${cart.totalMoney}"/> <!-- 제품별 총액 -->
									...
									<div class="row">
										...
										<div class="col-sm-4 text-center">
											<div class="total">
												<div class="sub">
													<p>
														<span>구매금액:</span> <span id="price"> ${total }원</span>
													</p>
													<p>
												...
												<div class="grand-total">
													...
													<p>
														<span><strong>실구매금액:<span id="sum">${total}</span>
														</strong></span>
													</p>
					...
					<div class="col-lg-8">
						<form method="post" name="od" class="colorlib-form" action="CartOrder.od">
							<h2>주문정보입력</h2>
		              	<div class="row">
			               <div class="col-md-12">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="fname">받는분</label>
										<input type="text" id="fname" name="o_name" class="form-control" placeholder="Your firstname">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="lname">전화번호</label>
										<input type="text" id="lname" name="o_phone" class="form-control" placeholder="'-없이'">
									</div>
								</div>
								...
								<div class="col-md-12">
			                    	...
			                    	<input type="text" id="companyname" name="o_email" class="form-control" placeholder="Company Name">
			                  </div>
			               </div>
								<div class="col-md-6">
			               ...
			               <div class="col-md-12">
									<div class="form-group">
										...
										<input type="button" value="우편번호 찾기" onclick="sample6_execDaumPostcode();" padding="10px" required/>
										</div>
								
									<div class="form-group">
										
										<input type="text" id="o_address1" name="o_address1" class="form-control" placeholder="우편번호">
										
									</div>
									
								
			                    	<input type="text" id="o_address2" name="o_address2"  class="form-control" placeholder="주소">
			                  </div>
			                  <div class="form-group">
			                    	<input type="text" id="o_address3"  name="o_address3" class="form-control" placeholder="상세주소">
			                  </div>
			               </div>
			            
			               <div class="col-md-12">
									<div class="form-group">
										<label for="companyname">배송요청사항</label>
			                    	<input type="text" id="towncity"  name="o_require" class="form-control" placeholder="Town or City">
			                  </div>
			               </div>
		               ...
		               <div class="row">
							<div class="col-md-12 text-center">
								<input type="submit" value="주문하기" class="btn btn-primary" onclick="CheckOrder(); return false;">
