			...
			<div
				...
				<form>
					<div style="padding-bottom: 10px;">
						<b style="font-size: 40px; color: gold;">${member.mem_id }님의<br>
							상세정보</b>
					</div>
					...
					<div  style="padding-top: 10px;">
						<button type="button"
							onclick="location.href='memberDeleteAction.me?id=${member.mem_id}';"
							>삭제</button>
					</div>
				</form>
			</div>
	...
	<section id="memberViewArea">
		<div style="padding-left: 5%; padding-right: 5%; padding-bottom: 5%;">
			<div style="border: 1px solid gold; padding-top: 50px; padding-bottom: 50px;">
				<form action="memberUpdate.me" method="post" name="f">
					<div style="padding-bottom: 10px;">
						<b style="font-size: 40px; color: gold;">${member.mem_id }님의 <br>
							정보 수정</b>
					</div>
					...
					<div style="padding-top: 5px;">
						<tr>
							<td>
								<th>아이디</th><br>
								<input type="text" placeholder="8~12자 영문과 숫자조합을 입력하세요." name ="mem_id" id = "mem_id"
										value="${member.mem_id}" placeholder="${member.mem_id}" readonly="readonly"
						...
						<tr>
							<td>
								...
								<input type="text" placeholder="한글,영문만 입력하세요.(특수문자 제외)" name ="mem_name" id = "mem_name"
										value="${member.mem_name}" placeholder="${member.mem_name}" required
										style="width: 50%; text-align: center;">
							</td>
						</tr>
					</div>
						...
						<tr>
							<td>
								...
								<input type="text" placeholder="ex) tss000 @ naver.com" name ="mem_email" id = "mem_email"
										value="${member.mem_email}" placeholder="${member.mem_email}" required
										style="width: 50%; text-align: center;">
							</td>
						</tr>
					</div>
						...
						<tr>
							<td>
								...
								<input type="text" placeholder="( - ) 없이 숫자만 입력하세요." name ="mem_call" id = "mem_call"
										value="${member.mem_call}" placeholder="${member.mem_call}" required
										style="width: 50%; text-align: center;">
							</td>
						</tr>
					</div>
						...
						<tr>
							<td>
								...
								<input type="text" name ="mem_postcode" id = "mem_postcode" placeholder="우편번호"
										value="${member.mem_postcode}" placeholder="${member.mem_postcode}" required
					...
					<div style="padding-top: 5px;">
						...
						<input type="text" name ="mem_address1" id = "mem_address1" placeholder="주소"
								value="${member.mem_address1}" placeholder="${member.mem_address1}" required
								style="width: 50%; text-align: center;">
					</div>
					...
					<div style="padding-top: 5px;">
						...
						<input type="text" name ="mem_address2" id="mem_address2" placeholder="상세주소" 
								value="${member.mem_address2}" placeholder="${member.mem_address2}" required
								style="width: 50%; text-align: center;">
					</div>
					...
					<div style="padding-top: 5px;">
						...
						<input type="text" name ="mem_address3" id="mem_address3" placeholder="참고항목"
								value="${member.mem_address3}" placeholder="${member.mem_address3}" required
								style="width: 50%; text-align: center;">
					</div>
					...
					<div style="padding-top: 5px;">
						<tr>
							<th>등급</th><br>
							<td><select name="mem_grade" style="width: 50%; height:44px; text-align: center;">
								<option value="1" ${member.mem_grade=='1'?"selected":""} >일반회원</option>
								<option value="0" ${member.mem_grade=='0'?"selected":""}>VIP</option>
								<option value="2" ${member.mem_grade=='2'?"selected":""}>관리자</option>
								</select>
							</td>
						</tr>
					</div>
