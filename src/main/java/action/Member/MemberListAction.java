	...
	request, HttpServletResponse response)
		throws Exception {
			...
			ActionForward forward = null;
				...
				MemberListService memberListService = new
				MemberListService();
				...
				int maxPage=(int)((double)listCount/limit+0.95); //총 페이지 수 계산 =>총글의갯수/출력될글의 갯수에 0.95를 하면 정수올림할수있음
		   		...
		   		int startPage = (((int) ((double)page / 10 + 0.9)) - 1) * 10 + 1;
		   	     ...
		   	     int endPage = startPage+5-1;//끝페이지 구함, 첫페이지1=>끝10 첫페이지 3=>12  +10부분을 조절하면 페이지수를 조절?
				...
				forward=new ActionForward("member_list.jsp",false);
		return forward;
	}
